    ...
    <script>
        $(document).ready(function(){
            $("#btn_add").click(function(){
                ...
                // $.get( "ajax.php", { NO: <?=$data['NO']?>, cnt: cnt } )
                // .done(function( data ) {
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="float-right">
                    <a href="javascript:;" class="btn btn-danger" data-sno="<?=$row1['NO']?>">삭제</a>
                </div>
                <?=$row1['WRITER']?>
                <?=$row1['DATE']?>
                <div class="clear"></div>
            ...
            <button type="button" id="btn_add">더보기</button>
        <br>
