    ...
    <div class="container">
        ...
        <table class="table table-striped">   
            ...
            <?php foreach($data as $row):?>
                <td><?=$row['NO']?></td>
                <td><a href="/view_board.php?no=<?=$row['NO']?>"><?=htmlspecialchars($row['TITLE'])?></a>[<?=$row['COMMENT_CNT']?>]</td>
        ...
        <!-- <ul class="pagination">
            <?php
                $last_page = $total_row_count/rowPerPage;
                if($total_row_count%rowPerPage !=0){
                    $last_page++;
                }
            ?>                     
            ...
            <?php
                if($current_page>1){
            ?>
            <li class="page-item"><a class="page-link" href="/list_board.php?current_page=<?=$current_page-1?>">이전</a></li>
            <?php
                }
            ?>
            ...
            ?>   
            <li class="page-item"><a class="page-link" href="/list_board.php?current_page=<?=$current_page+1?>">다음</a></li>
            <?php
                }
            ?>
